...
class RefundController extends Controller
{
    ...
    public function store(Request $request, Order $order)
    {
        ...
        $request->validate([
            ...
            'items.*.exchange_product_id' => 'nullable',
        ]);
        ...
        try {
            ...
            foreach ($request->items as $itemId => $data) {
                ...
                if ($type === 'exchange' && isset($data['exchange_product_id'])) {
                    if ($data['exchange_product_id'] != $orderItem->product_id) {
                        throw new \Exception("Produk tukar harus sama dengan produk yang dibeli.");
                    }
                }
                ...
                RefundItem::create([
                    ...
                    'exchange_product_id' => ($type === 'exchange') ? $orderItem->product_id : null,
                ]);
            ...
            $totalRefundedQty = RefundItem::where('type', 'return')
                ->whereHas('refund', function ($q) use ($order) {
