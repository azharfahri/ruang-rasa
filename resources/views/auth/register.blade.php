                        ...
                        <div
                            ...
                            <div class="auth-max-width col-sm-8 col-md-6 col-xl-7 px-4">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label">Konrifmasi Password</label>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <p class="fs-4 mb-0 text-dark">Sudah mempunyai akun?</p>
                                        <a href="{{ route('login') }}"
