<div class="card shadow-sm">
    ...
    <div class="mb-3">
        <label class="fw-bold small">Nama Customer</label>
        {{-- Atribut form="formBayar" ini harus cocok dengan ID di tag <form> --}}
        <input type="text" name="customer_name" class="form-control form-control-sm"
            placeholder="Masukkan nama..." form="formBayar" required>
    </div>

    @if ($order->exists)
        {{-- TAMBAHKAN id="formBayar" DI SINI --}}
        <form id="formBayar" method="POST" action="{{ route('cashier.orders.pay.cash', $order) }}">
            @csrf
