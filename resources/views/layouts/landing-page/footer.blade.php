                ...
                <div class="row mb-sm-12 mb-4">
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <ul class="d-flex flex-column gap-9">
                            ...
                            <li>
                                <a href="../main/form-bootstrap-validation.html"
                                    class="fs-4 text-body link-primary">Form Validation
                                </a>
                            </li>
                            <li>
                    ...
                    <div class="col-md-3 col-6">
                        ...
                        <ul class="d-flex flex-column gap-9">
                            ...
                            <li>
                                <a href="../main/table-layout-coloured.html"
                                    class="fs-4 text-body link-primary">Coloured Table</a>
                            </li>
                            <li>
                                <a href="../main/table-datatable-basic.html"
                                    class="fs-4 text-body link-primary">Basic Initialisation</a>
                            </li>
                            <li>
                                <a href="../main/table-datatable-api.html"
                                    class="fs-4 text-body link-primary">API</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-6">
