...
@section('content')
            ...
            <div class="custom-container">
                ...
                <div class="row align-items-end mb-3">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div
                            class="d-flex justify-content-center align-items-center gap-9 position-relative z-1 pb-lg-13">
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                ...
                                <img src="../assets/images/frontend-pages/icon-bootstrap.svg" width="28"
                                    height="28" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Sass">
                                <img src="../assets/images/frontend-pages/icon-sass.svg" width="28"
                                    height="28" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Gulp">
                                <img src="../assets/images/frontend-pages/icon-gulp.svg" width="28"
                                    height="28" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Figma">
                                <img src="../assets/images/frontend-pages/icon-figma.svg" width="24"
                                    height="24" alt="icon" />
                            </a>
                            <a class="d-flex align-items-center justify-content-center bg-white rounded-3 round-54 shadow"
                                href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-title="Apexchart">
                                <img src="../assets/images/frontend-pages/icon-apexchart.svg" width="24"
                                    height="24" alt="icon" />
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-none bg-primary-subtle rounded-24">
                            <div class="card-body text-center py-14 px-3">
                                ...
                                <p class="mb-14 fs-4">Brand new demos to help you build the perfect dashboard: <span
                                        class="fw-semibold">Dark</span> and <span
                                        class="fw-semibold">Right-to-Left.</span>
                                </p>
                                <img src="../assets/images/frontend-pages/screen.png" alt="icon"
        ...
        <section class="shadow-sm">
            <div class="border-top">
                <ul class="nav team-tab nav-tabs flex-nowrap overflow-x-auto container-fluid" id="myTab"
                    role="tablist">
                    <li class="nav-item " role="presentation">
                        <button
                            ...
                            id="team-tab" data-bs-toggle="tab" data-bs-target="#team-tab-pane" type="button"
                            role="tab" aria-controls="team-tab-pane" aria-selected="true">
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="payments-tab" data-bs-toggle="tab" data-bs-target="#payments-tab-pane"
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            class="nav-link py-7 fs-5 fw-semibold w-100 border-end d-flex justify-content-center align-items-center rounded-0"
                            id="embedding-tab" data-bs-toggle="tab" data-bs-target="#embedding-tab-pane"
                            type="button" role="tab" aria-controls="embedding-tab-pane" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <button
                            ...
                            id="workflows-tab" data-bs-toggle="tab" data-bs-target="#workflows-tab-pane"
                            type="button" role="tab" aria-controls="workflows-tab-pane" aria-selected="false">
                ...
                <div class="">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="team-tab-pane" role="tabpanel"
                            aria-labelledby="team-tab" tabindex="0">
                            <div class="row gap-lg-0 gap-7">
                                <div class="col-lg-6">
                                    <div class="bg-primary-subtle rounded-3 px-10 pt-5 pb-4">
                                        <img src="../assets/images/frontend-pages/tabsimage.png" alt="icon"
                                            class="w-100">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div
                                        ...
                                        <div class="accordion tabs-accordion my-4 w-100" id="accordionExample1">
                                            ...
                                            <div class="accordion-item border-0 border-bottom">
                                                <h2 class="accordion-header ">
                                                    <button
                                                        class="accordion-button shadow-none collapsed px-0 fs-5 fw-bold"
                                                        type="button" data-bs-toggle="collapse"
                        ...
                        <div class="tab-pane fade" id="payments-tab-pane" role="tabpanel"
                            ...
                            <div class="row gap-lg-0 gap-7">
                                ...
                                <div class="col-lg-6">
                                    <div
                                        class="d-flex flex-column h-100 justify-content-center align-items-start ps-lg-7">
                                        <h2 class="fs-10 fw-bolder">Defend your focus</h2>
                        ...
                        <div class="tab-pane fade" id="embedding-tab-pane" role="tabpanel"
                            aria-labelledby="embedding-tab" tabindex="0">
                            <div class="row gap-lg-0 gap-7">
                                <div class="col-lg-6">
                                    <div class="bg-primary-subtle rounded-3 p-13">
                                        <img src="../assets/images/frontend-pages/tabsimage.png" alt="icon"
                        ...
                        <div class="tab-pane fade" id="workflows-tab-pane" role="tabpanel"
                            aria-labelledby="workflows-tab" tabindex="0">
                            <div class="row gap-lg-0 gap-7">
                                <div class="col-lg-6">
                                    <div class="bg-primary-subtle rounded-3 p-13">
                                        <img src="../assets/images/frontend-pages/tabsimage.png" alt="icon"
                            ...
                            <div class="owl-carousel testimonial-carousel owl-theme">
                                <div class="item">
                                    <div>
                                        <div class="d-flex align-items-center gap-3 my-4">
                                            <div>
                                                <img src="../assets/images/frontend-pages/user_1.png" width="56"
                                                    height="56" alt="user">
                                            </div>
                                ...
                                <div class="item">
                                    <div>
                                        <div class="d-flex align-items-center gap-3 my-4">
                                            <div>
                                                <img src="../assets/images/frontend-pages/user-2.png" width="56"
                                                    height="56" alt="user">
                                            </div>
                                ...
                                <div class="item">
                                    <div>
                                        <div class="d-flex align-items-center gap-3 my-4">
                                            <div>
                                                <img src="../assets/images/frontend-pages/user-3.png" width="56"
                                                    height="56" alt="user">
                                            </div>
                            ...
                            <div class="card p-7 mb-0 rounded-3 border">
                                ...
                                <div class="my-sm-7 my-3 d-flex flex-column gap-3">
                                    <div class="d-flex gap-2">
                                        <img src="../assets/images/frontend-pages/icon-circle-check.svg"
                                            alt="">
            ...
            <div class="container-fluid">
                        ...
                        <div class="my-13">
                            <div class="accordion faq-accordion" id="accordionExample1">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button fs-5" type="button"
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <p class="text-center fs-3 fw-bold dashed-border py-1 px-2 rounded mb-0">
                        Still have a question? <a target="_blank" href="https://discord.com/invite/XujgB8ww4n"
                            class="text-underline text-body">Ask on
                            discord</a> or
                        <a target="_blank" href="https://adminmart.com/support/"
                            class="text-underline text-body">submit a ticket</a>.
                    </p>
                </div>
            </div>
        </section>
                            ...
                            <div class="py-lg-12 ps-lg-12 py-5 px-lg-0 px-9">
                                ...
                                <div
                                    ...
                                    <a href="../main/authentication-login.html"
                                        class="btn btn-primary py-6 px-9">Member Login</a>
